...
/**
* Template name: Service Design Template
*/
...
<main class="content mr-top">
		...
		<?php get_template_part( 'template-parts/service-design-menu-inner', 'services-design-menu-inner' ); ?>
								...
								<div class="list-row">
									<div class="list-content">
										<div class="list-composition">
											<a href="<?php echo esc_html(get_post_meta($post->ID, $key = 'link', $single = true)); ?>"> 
												<p class="h3"><?php esc_html(the_title()); ?></p>
											</a>
											<div class="list-text">
...
<?php get_template_part( 'template-parts/service-modal-inner-filter', 'service-modal-inner' ); ?>
