					...
					<div class="filter-wrap">
						<ul class="filter-list">
                        	...
                        	foreach($wcatTerms as $wcatTerm) : ?>
                        		...
                        		<li class="filter filter_mobile"><a href="<?php echo ('/portfolio/'. $wcatTerm->slug) . '/'?>"><?php echo $wcatTerm->name; ?></a></li>
		...
		<div class="container-fluid">
			<div id="portfolio-grid">
				...
				<?php  
                    ...
                    $resent_list = new WP_Query(array('post_type'=> 'portfolio', 'order'=> 'DESC', 'posts_per_page'=> -1));

                    if ( $resent_list->have_posts() ) :
                       	while ( $resent_list->have_posts() ) :
                          		$resent_list->the_post(); ?>
					   <a class="item-project item-project-portfolio overlay" href="<?php esc_url(the_permalink()); ?>" style="background-image: url(<?php esc_url(the_post_thumbnail_url()); ?>);">			
            ...
            <div class="modal-body">
                <ul class="modal-filter-list">
                    ...
                    foreach($wcatTerms as $wcatTerm) : ?>
                      ...
                      <li class="filter"><a href="<?php echo ('/portfolio/'. $wcatTerm->slug) .'/' ?>"><?php echo $wcatTerm->name; ?></a></li>
