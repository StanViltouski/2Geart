						...
						if ( $resent_list->have_posts() ) {
	            			...
	            			$resent_list->the_post(); ?>
								...
								<div class="col-6 change_post_link" style="background: url(<?php esc_url(the_post_thumbnail_url()); ?>)no-repeat center/cover;">
									<div class="change_post_overlay"><a href="<?php esc_url(the_permalink()); ?>"></a></div>
									<div class="change_post_content">
										<p><a href="<?php esc_url(the_permalink()); ?>">Project Prev</a></p>
						...
						if ( $resent_list->have_posts() ) {
	            			...
	            			$resent_list->the_post(); ?>
								...
								<div class="col-6 change_post_link" style="background: url(<?php esc_url(the_post_thumbnail_url()); ?>)no-repeat center/cover;">
									<div class="change_post_overlay"><a href="<?php esc_url(the_permalink()); ?>"></a></div>
									<div class="change_post_content">
										<p><a href="<?php esc_url(the_permalink()); ?>">Project Next</a></p>
										<div class="postLink_desc">
											<h3><?php the_title(); ?></h3>
											<p><?php echo wp_trim_words( get_the_excerpt(), '16' ); ?></p>
										</div>
