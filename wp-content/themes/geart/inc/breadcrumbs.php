...
function get_breadcrumbs() {
	...
	$show_title     = 1;
	$delimiter      = false;
	$before         = '<li class="current"><span itemprop="title">';
	$after          = '</span></li>';
	...
	$link_after   = '</li>';
	$link_attr    = ' ';
	$link         = $link_before . '<a itemprop="url"' . $link_attr . ' href="%1$s"><span itemprop="title">%2$s</span></a>' . $link_after;
	...
	if (is_home() || is_front_page()) {
		...
		if ($show_on_home == 1) echo '<div><a itemprop="url" href="' . esc_url($home_link) . '"><span itemprop="title">' . $text['home'] . '</span></a></div>';
