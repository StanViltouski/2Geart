...
if (navfix.length) {
	...
	$(window).on('scroll', function(){
		...
		if(!$("header").hasClass("on") && $(window).width() > 960) {
			...
			if (scroll < navHeight) {
				...
				($("body").hasClass("page")) ?
				$(".logo .img-svg").attr("src", "https://2geart.com/wp-content/themes/geart/img/logo-black.svg") :
				$(".logo .img-svg").attr("src", "https://2geart.com/wp-content/themes/geart/img/logo.svg");
				...
				$(".logo .img-svg").attr("src", "https://2geart.com/wp-content/themes/geart/img/logo-2-geart.svg");
			}
...
$(window).on('resize', hideButton);

function hideButton() {

	($(window).width() < 576 && $("header").hasClass('on')) ? 
		$('.headerBtn-big-mobile').css('display', 'none') : 
		$('.headerBtn-big-mobile').css('display', 'block') 
}
...
if ($(window).width() < 992) {
	...
	$(".toggle-mnu").on('click', function() {
		...
		$(".page .main-menu a").css('color', '#000');
		if($("header").hasClass('on')) {
			$(".button").css({'backgroundColor' : '#fff', 'color' : '#000'});
		} else { $(".button").css({'backgroundColor' : '#febb16', 'color' : '#fff'}); }
	...
	var number_percentage = $(".number-percentage");
		...
		if ($('.s-adv').length > 0) {
			var waypoint = new Waypoint({
				element: document.getElementsByClassName('s-adv'),
...
// Single-portfolio hover tabs

$('.change_post_link').on({
	
	'mouseenter' : function(){
		$(this).children('.change_post_overlay').css({
                   'opacity' : '0.5',
                   'transition' : '0.5s',
               });
	},
...
$('.filter-map').on('click', function(){
	...
	$('.filter-map').css('color', '#444');
	$('.address-item').css('display', 'none');
	$(this).css('color', '#febb16');
	var num_map = $(this).attr('data-map');

	$('.address-item:eq('+(num_map-1)+')').show(500);
});

//Contacts tabs

(function() {
	$('.button-wrap-map .btn-small').on('click', function(event){
		...
		if($(this).hasClass('active')) {
			...
			$('.address .button-wrap-map .btn-small').css('color', '#febb16');
...
$(function(){
	...
	if(localStorage.form_send) {
    		 setTimeout(function () {localStorage.removeItem("form_send"); }, 60000);
    	}
    ...
    if(!localStorage.form_send) {
		$('#form_request').on('submit', function(e){
	 	...
	 	$.ajax({
	 		url: "https://2geart.com/wp-content/themes/geart/mail.php",
	 		type: 'POST',
	 		contentType: false, 
	 		processData: false, 
	 		data: fd,
	 		success: function(msg){
				if(msg == 'ok') {
			 		...
			 		localStorage.setItem('form_send', 'send');
				} else {
	 			alert('Error')
				}
			 }
