				...
				<div class="col-12">
					...
					<div class="filter-wrap">
						...
						<ul class="filter-list">
							<li id="button_filter" class="filter" data-toggle="modal" data-target="#exampleModal"><a href="/portfolios">All Projects </a><i class="fa fa-chevron-down" aria-hidden="true"></i></li>
