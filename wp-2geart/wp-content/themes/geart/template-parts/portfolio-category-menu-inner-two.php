				...
				<div class="col-12">
					...
					<div class="filter-wrap">
                        <ul class="filter-list">
                            <li id="title_filter-inner" class="filter" data-toggle="" data-target="#modal-filter-inner-two"><a href="/portfolios">All Projects </a><i class="fa fa-chevron-down" aria-hidden="true"></i></li>
